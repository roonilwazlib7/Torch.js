  ...
  Sprite = (function() {
    ...
    Sprite.prototype.UpdateGLEntities = function() {
      if (this.GL && this.gl_three_sprite) {
        return this.Three().Position("x", this.Rectangle.x).Position("y", this.Rectangle.y).Position("z", this.Rectangle.z).Rotation(this.rotation).Opacity(this.opacity).DrawIndex(this.drawIndex);
      }
    };
