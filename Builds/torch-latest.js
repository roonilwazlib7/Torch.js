...
(function() {
  ...
  JerkFollow = (function() {
    ...
    function JerkFollow(camera1, sprite1, offset, config1) {
      var v;
      this.camera = camera1;
      this.sprite = sprite1;
      this.config = config1;
  ...
  WebGLGame = (function(superClass) {
    ...
    function WebGLGame(canvasId1, width1, height1, name1, graphicsType1, pixel1) {
      this.canvasId = canvasId1;
      this.width = width1;
      this.height = height1;
      this.name = name1;
    ...
    WebGLGame.prototype.UpdateSprites = function() {
      var cleanedSprites, k, len, ref, sprite;
      cleanedSprites = [];
      ref = this.spriteList;
      for (k = 0, len = ref.length; k < len; k++) {
        sprite = ref[k];
  ...
  Actor = (function() {
    ...
    Actor.prototype.UpdateActor = function() {
      var item, k, len, offset, rect, ref;
      this.inFluid = false;
      this.onGround = false;
      this.onTop = false;
      this.onRight = false;
  ...
  ({
    ...
    Update: function() {
      var item, k, len, newRec, ref, results, spr, viewRect;
  ...
  SpawnItem = (function() {
    function SpawnItem(spawnType, spawned, obj1, position) {
  ...
  PlayList = (function(superClass) {
    ...
    function PlayList(game1, songList) {
      this.game = game1;
