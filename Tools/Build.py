...
items = ["pixl/pixl.js", "Torch.js", "Torch.Keys.js", "Torch.Mouse.js","Torch.Viewport.js","Torch.Game.js","Torch.Load.js", "Torch.Electron.js", "Torch.Camera.js", "math.js", "Torch.Timer.js","Torch.Sprite.js","Torch.Animation.js", "Torch.Text.js", "Torch.Sound.js","Torch.Color.js", "Torch.StateMachine.js", "Torch.Particles.js", "Torch.Debug.js", "Torch.GamePad.js", "Torch.SpriteGroup.js", "Torch.Platformer.js"]
NAME = "Torch-" + BUILD
for path in items:
    f = open("Core/" + path)
    COMBINED += f.read()
